...
esp_err_t lcd_camera_start(const lcd_camera_config_t *config) {
    ...
    xTaskCreatePinnedToCore(display_and_send_task, "lcd_display", 8192, NULL, 4, NULL, 0);
    xTaskCreatePinnedToCore(capture_task, "camera_cap", 4096, NULL, 4, NULL, 1);
